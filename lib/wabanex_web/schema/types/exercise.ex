defmodule WabanexWeb.Schema.Types.Exercise do
  ...
  input_object :create_exercise_input do
    ...
    field :youtube_video_url, non_null(:string), description: "Exercise's Youtube video URL"
    field :protocol_description, non_null(:string), description: "Exercise's methodology"
    field :repetitions, non_null(:string), description: "Number of times the exercise is going to repeat"
  end
end
